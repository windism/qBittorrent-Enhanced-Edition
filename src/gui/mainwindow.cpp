...
void MainWindow::reloadSessionStats()
{
    ...
    {
        setWindowTitle(tr("[D: %1, U: %2] qBittorrent Edition %3", "D = Download; U = Upload; %3 is qBittorrent version")
...
void MainWindow::on_actionSpeedInTitleBar_triggered()
{
    ...
    if (m_displaySpeedInTitle)
        ...
        setWindowTitle(QStringLiteral("qBittorrent Edition " QBT_VERSION));
}
